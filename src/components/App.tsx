  ...
  if (publicPage === 'nearby') {
    return (
      <div className="min-h-screen bg-slate-50">
        <header className="fixed top-0 w-full p-4 bg-white shadow-sm flex items-center justify-center z-50">
          <img src="https://waxolpvdayhkqhtfnbfk.supabase.co/storage/v1/object/public/logo/eAYUSHSeva%20(1).png" alt="AYUSH" className="h-10" />
        </header>
        <div className="pt-16">
